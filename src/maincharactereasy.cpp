...
maincharactereasy::maincharactereasy(data* data): _data(data){}

void maincharactereasy::draw()
{
...
sf::Vector2f maincharactereasy::getPosition()
{
    p.getPosition();
    return p.getPosition();
}
void maincharactereasy::setPosition(int x,int y)
{
    p.setPosition(x,y);
}
void maincharactereasy::processInput()
{
    sf::Event event;
